...
//  método: DELETE
//  ●
app.delete('/delete-parametros-consulta/', function (request, response) {
    let cc = request.query.cc;
...
// ● domicilio
// método: PUT
app.put('/put-parametro-consulta-body-cabecera/', function (request, response) {
    let cc = request.query.cc;
...
// ● domicilio
// método: GET
app.get('/get-parametros-consulta-ruta-cabecera/:cantidad/:marca/', function (request, response) {
